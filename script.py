...
con.execute("INSERT INTO todo (task,status) VALUES ('Read A-byte-of-python to get a good introduction into Python',1)")
con.execute("INSERT INTO todo (task,status) VALUES ('Hi',1)")
